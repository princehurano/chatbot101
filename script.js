...
Problem 4: There is no centralized, automated inquiry system that provides immediate access to official school information.`
    ...
    requirements: {
        ...
        response: 'Admission requirements include: 
            1) Completed application form, 2) Birth certificate, 3) Previous school report card, 4) Vaccination records, 5).'
    },
    vision: {
...
// Welcome Message 
window.addEventListener('load', () => {
    const welcomeText = 'Good Day! This a Developed Keyword Web-based School Information Chatbot made by the TVL-ICT Researchers.\nHow may I help you?';
